...
function Table(baseProps, ref) {
    ...
    var refTBody = (0, react_1.useRef)(null);
    ...
    function getDefaultFiltersAndSorters() {
        ...
        flattenColumns.forEach(function (column) {
            ...
            var hasDefaultSortOrder = 'defaultSortOrder' in column && typeof column.defaultSortOrder !== 'undefined' && column.defaultSortOrder !== null;
            var hasSortOrder = 'sortOrder' in column && typeof column.sortOrder !== 'undefined' && column.sortOrder !== null;
            if (hasDefaultSortOrder || hasSortOrder) {
                var priority = (0, utils_1.getSorterPriority)(column.sorter);
                var direction = hasSortOrder ? column.sortOrder : column.defaultSortOrder;
    ...
    function renderTbody() {
        var producer = (0, is_1.isObject)(scroll) &&
            ...
            (0, is_1.isArray)(data) &&
            data.length > 0;
        return (react_1.default.createElement(resizeObserver_1.default, { onResize: setScrollBarStyle, getTargetDOMNode: function () { return refTableBody.current || refTBody.current; } }, fixedHeader && !virtualized ? (react_1.default.createElement(ComponentBodyWrapper, { ref: refTableBody, className: prefixCls + "-body", style: scrollStyleY },
