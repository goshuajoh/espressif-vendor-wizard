...
def create_customer(customer_data: list, use_internal: bool = False) -> dict:
    ...
    # Build the full request payload (per documentation - no jsonrpc wrapper needed)
    payload = {
        "params": {
            "timestamp": timestamp,
            "client_id": CLIENT_ID,
    ...
    # Make the request
    # X-ODOO-DATABASE-NAME header is required per documentation
    headers = {
...
def get_test_customer_data() -> list:
    ...
    return [{
        ...
        # Optional fields
        "number": "",
        "note": "Test customer created via API with Org ID LXX",
        "inv_tax_number": "1236",
        
        # Contact information (custom fields)
        "x_char_t6itzytspg": "Joshua Test3",           # 采购联系人
        "x_char_vitg7ywwao": "+86-21-12345678",       # 采购联系人电话
        "x_char_9eqgn6f0dv": "+86-21-87654321",       # 固定联系电话
        "x_char_0gmeycjxmg": "test2@espressif.com",    # 采购联系人邮箱
