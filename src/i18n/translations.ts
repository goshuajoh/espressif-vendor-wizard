...
export const translations = {
  ...
  product: {
    ...
    selectProductFirst: { zh: '请先选择产品系列，然后选择具体型号', en: 'Please select a product family first, then choose specific variants' },
  },
  ...
  customization: {
    ...
    hint: { zh: '如果您需要以上定制服务，请选择"是"。我们的技术团队将与您联系讨论具体需求。', en: 'If you need any of the above customization services, please select "Yes". Our technical team will contact you to discuss specific requirements.' },
  },
